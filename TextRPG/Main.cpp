...
int main() {
	...
	// 각 아이템 정보들을 설정해준다.
	// ================ 무기정보 설정 =================
	strcpy_s(tStoreWeapon[0].strName, "기본칼");
	strcpy_s(tStoreWeapon[0].strTypeName, "무기");
	strcpy_s(tStoreWeapon[0].strDesc, "그냥 칼이다");
	...
	strcpy_s(tStoreWeapon[1].strName, "중급 활");
	...
	strcpy_s(tStoreWeapon[2].strName, "최상급 활");
	strcpy_s(tStoreWeapon[2].strTypeName, "무기");
	strcpy_s(tStoreWeapon[2].strDesc, "개쌤");
	tStoreWeapon[2].eType = IT_WEAPON;
	tStoreWeapon[2].iMin = 90;
	tStoreWeapon[2].iMax = 150;
	tStoreWeapon[2].iPrice = 500000;
	tStoreWeapon[2].iSell = 300000;
	...
	strcpy_s(tStoreArmor[1].strName, "중갑갑옷");
	strcpy_s(tStoreArmor[1].strTypeName, "방어구");
	strcpy_s(tStoreArmor[1].strDesc, "철로 만든 단단한 갑옷");
	tStoreArmor[1].eType = IT_ARMOR;
	tStoreArmor[1].iMin = 20;
	tStoreArmor[1].iMax = 40;
	tStoreArmor[1].iPrice = 50000;
	tStoreArmor[1].iSell = 30000;

	strcpy_s(tStoreArmor[2].strName, "최상급 갑옷");
	strcpy_s(tStoreArmor[2].strTypeName, "방어구");
	strcpy_s(tStoreArmor[2].strDesc, "ㅈㄴ단단함");
	tStoreArmor[2].eType = IT_ARMOR;
	tStoreArmor[2].iMin = 140;
	tStoreArmor[2].iMax = 160;
	tStoreArmor[2].iPrice = 500000;
	tStoreArmor[2].iSell = 30000;
